...
class WorkersController extends Controller
{
    ...
    public function actionAddWorker()
    {
        ...
        $model->wor_id = $post_fields['work'];
        $model->eng_id = $post_fields['eng'];
    ...
    public function actionDelWorker()
    {
        ...
        $this->findModel($post_fields['id'])->delete();
    }

    public function actionReplaceWorkers()
    {
        $works_model = Works::find()->all();

        foreach ($works_model as $work) {
            $model = new Workers();

            $model->wor_id = $work->id;
            $model->eng_id = $work->engineer_id;
